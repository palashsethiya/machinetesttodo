...
import 'package:machinetesttodo/screens/EditUser.dart';
import 'package:machinetesttodo/screens/addUser.dart';
import 'package:machinetesttodo/screens/viewUser.dart';
          ...
          itemBuilder: (context, index) {
            return Card(
              child: ListTile(
                ...
                title: Row(
                  children: [Text("${_userList[index].firstName} " ?? ''), Text(_userList[index].lastName ?? '')],
                ),
                subtitle: Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
                  children: [Text(_userList[index].contact ?? ''), Text(_userList[index].email ?? '')],
                ),
                trailing: Row(
